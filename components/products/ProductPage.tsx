...
import { FilterIcon, RefreshIcon, SearchIcon, ChevronUpIcon, ChevronDownIcon, DownloadIcon } from '../core/Icons';
                ...
                <div className="bg-white rounded-lg shadow-sm border mt-4">
                    ...
                    >
                        <div className="flex items-center">
                            <img src="https://static-images.ifood.com.br/image/upload/t_high/logosgde/ifood-01.png" alt="iFood Logo" className="h-6 mr-3"/>
