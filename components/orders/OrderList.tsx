...
import { RefreshIcon, FilterIcon, ChevronRightIcon, SpeakerOnIcon, SpeakerOffIcon, CalendarIcon, SearchIcon } from '../core/Icons';
                ...
                <div className="flex justify-between items-start">
                    <div>
                        ...
                        <div className="flex items-center space-x-2 mt-1">
                            ...
                            {order.isIfood && (
                                <span className="text-red-600 font-bold text-sm">iFood</span>
                            )}
                        </div>
                    </div>
